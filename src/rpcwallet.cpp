...
Value sendtobetzyy(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            ...
            "\"transactionid\"  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("sendtobetzyy", "0.1")
            + HelpExampleCli("sendtobetzyy", "0.1 \"donation\" \"seans outpost\"")
            + HelpExampleRpc("sendtobetzyy", "0.1, \"donation\", \"seans outpost\"")
        );
